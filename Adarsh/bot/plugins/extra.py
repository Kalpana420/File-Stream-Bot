    ...
    try:
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="ɪ  ᴀᴍ  ᴍᴀɪɴᴛᴀɪɴᴇᴅ  ʙʏ  [ʀᴀʜᴜʟ](https://telegram.me/itsssSoMe1)",
                    
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ   🧑‍💻", url=f"https://telegram.me/itsssSoMe1")
                            ]
                        ]
                    ),
...
async def follow_user(b,m):
    btn = [[
        ...
        InlineKeyboardButton(text="ɪɴꜱᴛᴀɢʀᴀᴍ", url="https://www.instagram.com/goodmovies.clip?igsh=MWswYWRuOTZuam4yaQ==")
        ],[
    ...
    try:
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
                ...
                await StreamBot.send_photo(
                    chat_id=m.chat.id,
                    photo='https://graph.org/file/132e6aeba58845b266177.jpg',
